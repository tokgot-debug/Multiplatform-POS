  ...
  async renderLedger(pane) {
    ...
    document.getElementById('ledg-autofill-btn').addEventListener('click', async (e) => {
      ...
      const aiImageMap = [
        ...
        { keywords: ['whiskey', 'whisky', 'jack daniel', 'balvenie', 'glenfiddich', 'king robert', 'bond 7'], url: '/ai_images/whiskey_glass.jpg' },
        { keywords: ['konyagi', 'gin', 'gordon', 'tanqueray', 'gilbeys'], exclude: ['ginger', 'charging'], url: '/ai_images/gin_glass.jpg' },
        { keywords: ['rose', 'rosé', 'allee bleue'], url: '/ai_images/rose_wine.jpg' },
        { keywords: ['syrah', 'primitivo', 'cabernet', 'merlot', 'shiraz', 'pinot noir'], url: '/ai_images/red_wine_bottle.jpg' },
