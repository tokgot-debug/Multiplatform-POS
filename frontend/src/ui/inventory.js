  ...
  async renderLedger(pane) {
    ...
    document.getElementById('ledg-autofill-btn').addEventListener('click', async (e) => {
      ...
      const aiImageMap = [
        ...
        { keywords: ['beans', 'maharagwe', 'madondo', 'minji', 'ndengu'], exclude: ['coffee', 'espresso', 'jelly', 'cocoa', 'vanilla'], url: '/ai_images/chapati_beans.jpg' },
        { keywords: ['jw blue', 'blue label'], url: '/ai_images/blue_label.jpg' },
        { keywords: ['william lawson', 'william lawsons', 'william'], url: '/ai_images/william_lawson.jpg' },
        { keywords: ['jameson'], url: '/ai_images/jameson_bottle.jpg' },
        { keywords: ['johnnie walker', 'black label', 'red label', 'gold label', 'green label'], url: '/ai_images/johnnie_walker.jpg' },
        { keywords: ['savanna', 'cider', 'hunters'], url: '/ai_images/cider_glass.jpg' },
        { keywords: ['guinness', 'stout', 'milk stout'], url: '/ai_images/stout_glass.jpg' },
        { keywords: ['tusker'], url: '/ai_images/tusker_lager.jpg' },
        { keywords: ['white cap', 'whitecap'], url: '/ai_images/whitecap_lager.jpg' },
        { keywords: ['beer', 'lager', 'senator', 'pilsner', 'heineken', 'bavaria', 'peroni', 'corona', 'hunter', 'faxe', 'tuborg', 'guiness', 'ko', 'desperados'], exclude: ['glass', 'mug'], url: '/ai_images/beer_glass.jpg' },
        { keywords: ['smirnoff', 'vodka', 'ciroc', 'grey goose', 'absolut', 'ketel one', 'belvedere', 'kibao', 'chrome', 'flirt', 'magic', 'titos', 'popov', 'red star'], url: '/ai_images/vodka_glass.jpg' },
        { keywords: ['whiskey', 'whisky', 'jack daniel', 'balvenie', 'glenfiddich', 'king robert', 'bond 7', 'glenmorangie', 'chivas', 'macallan', 'talisker', 'singleton', 'bourbon', 'makers mark', 'wild turkey', 'famous grouse', 'cardhu', 'glenlivet', 'dalwhinnie', 'black & white', 'crown royal', 'nikka', 'grants', 'dewars', 'lagavulin'], url: '/ai_images/whiskey_glass.jpg' },
        { keywords: ['konyagi', 'gin', 'gordon', 'tanqueray', 'gilbeys', 'bombay', 'beefeater', 'hendricks', 'chrome gin', 'best gin', 'kenya cane', 'mr dowells'], exclude: ['ginger', 'charging'], url: '/ai_images/gin_glass.jpg' },
        { keywords: ['rose', 'rosé', 'allee bleue', 'zinfandel rose', 'rosato', 'blush'], url: '/ai_images/rose_wine.jpg' },
        { keywords: ['syrah', 'primitivo', 'cabernet', 'merlot', 'shiraz', 'pinot noir', 'malbec', 'zinfandel', 'chianti', 'rioja', 'bordeaux', 'burgundy', 'tempranillo', 'rosso', 'nero', 'sangiovese', 'garnacha'], url: '/ai_images/red_wine_bottle.jpg' },
        { keywords: ['wine', 'red wine', 'white wine', 'chardonnay', 'sauvignon blanc', 'chenin blanc', 'moscato', 'champagne', 'prosecco', 'sparkling wine', 'moet', 'clicquot', 'dom perignon', 'belaire', 'luc belaire', 'blanc', 'cuvee', 'brut', 'sweet white', 'sweet red'], exclude: ['glasses', 'glassware'], url: '/ai_images/red_wine_glass.jpg' },
        { keywords: ['coca-cola', 'coca cola', 'coke'], url: '/ai_images/coke_bottle.png' },
        { keywords: ['fanta', 'sprite', 'stoney', 'krest', 'soda', 'novida', 'bitter lemon', 'ginger ale', 'tonic'], url: '/ai_images/fanta_glass.jpg' },
        { keywords: ['fresh juice', 'juice', 'passion', 'mango', 'orange', 'pineapple', 'tropical', 'delmonte', 'pick n peel'], exclude: ['vape', 'e-liquid', 'vaping'], url: '/ai_images/fresh_juice.jpg' },
        { keywords: ['mineral water', 'water', 'aqua', 'dasani', 'keringet', 'rwenzori', 'waba'], exclude: ['watermelon', 'tonic', 'watercress'], url: '/ai_images/mineral_water.jpg' },
        { keywords: ['nyama choma', 'choma', 'roasted meat', 'goat ribs', 'pork ribs', 'mbuzi', 'beef on bone', 'pork', 'matumbo', 'beef steak', 'liver', 'tripe', 'osubucco', 'beef', 'meat', 'sausage', 'kebab', 'smokie', 'wings', 'kuku', 'chicken', 'broiler'], url: '/ai_images/nyama_choma.jpg' },
        ...
        { keywords: ['ugali', 'beef stew', 'stew', 'sukuma', 'managu', 'spinach', 'cabbage', 'terere', 'kunde', 'nduma', 'sweet potatoes', 'arrow roots', 'yams', 'potatoes', 'dhania', 'hoho', 'lemon', 'vanilla', 'tomato', 'onion', 'leek'], exclude: ['beans'], url: '/ai_images/ugali_nyama.jpg' },
        { keywords: ['samosa', 'sambusa', 'eggs', 'omelette', 'breakfast', 'pancake'], url: '/ai_images/beef_samosas.jpg' },
        { keywords: ['cognac', 'brandy', 'martell', 'hennessy', 'remy martin', 'courvoisier', 'viceroy', 'richot', 'napoleon', 'vsop', 'xo', 'camus', 'bisquit', 'meukow'], url: '/ai_images/whiskey_glass.jpg' },
        { keywords: ['rum', 'bacardi', 'captain morgan', 'malibu', 'havana club', 'myers', 'old monk', 'appleton', 'zacapa', 'barcelo'], url: '/ai_images/whiskey_glass.jpg' },
        { keywords: ['tequila', 'jose cuervo', 'patron', 'don julio', 'camino', 'sauza', 'olmeca', 'clase azul', 'casamigos', 'teremana'], url: '/ai_images/gin_glass.jpg' },
        { keywords: ['liqueur', 'amarula', 'baileys', 'kahlua', 'jagermeister', 'campari', 'martini', 'zappa', 'sambuca', 'sherry', 'port', 'butlers', 'tripple sec', 'triple sec', 'blue curacao', 'grandmarnier', 'bottega', 'limoncello', 'soju'], url: '/ai_images/vodka_glass.jpg' },
        { keywords: ['milk', 'yoghurt', 'maziwa', 'coffee', 'tea', 'latte', 'espresso', 'cappuccino', 'mocha', 'macchiato', 'americano', 'hot chocolate', 'masala tea', 'black tea', 'white coffee', 'dawa', 'cocoa'], url: '/ai_images/fresh_juice.jpg' },
        { keywords: ['cooking oil', 'flour', 'sugar', 'salt', 'spice', 'royco', 'masala', 'sauce', 'honey', 'vinegar', 'baking powder', 'gel', 'ginger', 'garlic'], url: '/ai_images/mineral_water.jpg' },
        { keywords: ['serviettes', 'tissue', 'foil', 'packaging', 'container', 'bags', 'glasses', 'mugs', 'towels', 'scrubber', 'bleach', 'safisha', 'pin', 'knife', 'forks', 'straws', 'dustbin', 'mop', 'airfreshner', 'book', 'liquid', 'detergent', 'towel', 'pan', 'cling film', 'bag', 'gloves', 'spoons', 'buckets', 'margarine', 'panadol', 'paper', 'jugs', 'wrap', 'fresher', 'toaster'], url: '/ai_images/vip_service.jpg' },
        { keywords: ['shawarma', 'mashed potato', 'osubuco', 'bones', 'ribs', 'mayai'], url: '/ai_images/beef_samosas.jpg' },
        { keywords: ['cocktail', 'negroni', 'sex on the beach', 'hot tody'], url: '/ai_images/fresh_juice.jpg' },
        { keywords: ['750ml', '1l', '1000ml', '700ml', '375ml', '500ml', '1.5l', '1500ml', '750mi', '1000mi', '200ml', '50ml', '330ml'], url: '/ai_images/red_wine_glass.jpg' },
        { keywords: [''], url: '/ai_images/vip_service.jpg' }
      ];
